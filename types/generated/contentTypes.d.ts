...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isAdmin: Attribute.String;
    FirstName: Attribute.String;
    LastName: Attribute.String;
    Licenses: Attribute.Integer;
    Brand: Attribute.String;
    Country: Attribute.String;
    activationDate: Attribute.Date;
    endDate: Attribute.Date;
    PackageType: Attribute.String;
    premiums: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::order.order'
    >;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paymentInterval: Attribute.String;
    createAt: Attribute.DateTime;
    updateAt: Attribute.DateTime;
    startDate: Attribute.DateTime;
    endDate: Attribute.DateTime;
    productId: Attribute.String;
    subscriptionId: Attribute.String & Attribute.Unique;
    title: Attribute.String;
    status: Attribute.String;
    paymentIntentId: Attribute.String;
    trailEnd: Attribute.DateTime;
    trailStart: Attribute.DateTime;
    setupIntentId: Attribute.String;
    trialPeriodDays: Attribute.Integer;
    canceled: Attribute.Boolean & Attribute.DefaultTo<false>;
    canceledDate: Attribute.DateTime;
    cancellationDetails: Attribute.Text;
    user: Attribute.Relation<
      'api::order.order',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    imageId: Attribute.String;
...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    status: Attribute.String;
    intentId: Attribute.String & Attribute.Unique;
    customerId: Attribute.String;
    mode: Attribute.String;
    createAt: Attribute.DateTime;
    updateAt: Attribute.DateTime;
    amount: Attribute.Float;
    currencyType: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPromocodePromocode extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    duration: Attribute.Enumeration<['once', 'repeating', 'forever']>;
    couponId: Attribute.String;
    valid: Attribute.Boolean & Attribute.DefaultTo<true>;
    currency: Attribute.String;
    percent_off: Attribute.String;
    amount_off: Attribute.String;
    duration_in_months: Attribute.String;
    max_redemptions: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
